fn main() {
    ...
    ignoring_an_entire_value(3, 4);
    ignoring_part_of_value();
    ignoring_an_unused_variables();
    ignoring_remaining_parts_of_value();
...
fn ignoring_an_entire_value(_: i32, y: i32) {
    println!("This code only uses the y parameter: {}", y);
}

fn ignoring_part_of_value() {
...
fn ignoring_an_unused_variables() {
    let _x = 5;
    let y = 10;
...
fn ignoring_remaining_parts_of_value() {
    struct Point {
        x: i32,
        y: i32,
        z: i32,
